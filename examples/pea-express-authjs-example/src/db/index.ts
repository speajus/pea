...
export class ClientConfig implements Config {
    constructor(private _url = envRequired("DATABASE_URL"), public _authToken = envRequired("DATABASE_AUTH_TOKEN")) {
...
export const drizzlePeaKey = peaKey<ReturnType<typeof drizzleFactory>>("drizzle");
